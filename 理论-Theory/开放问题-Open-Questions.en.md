...
| Q4 | How do exceptions and state survive replacement? | Rule retention after a fresh session and state reconciliation | RFC-0002 with deliberate context resets and replacement |
